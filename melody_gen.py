...
def generate_melody(chord_progression, melody_rhythm):
    choose_note(chord_progression, melody_rhythm)
    return melody_stream


def choose_note(chord_progression, melody_rhythm):
        ...
        while x != 4:
            ...
            if x == 0:
                ...
                if note > 6:
                    ...
                    note = note - 6
                # Create a new note
                new_note = music21.note.Note(c_major_notes[note])
