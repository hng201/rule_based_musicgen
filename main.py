...
if __name__ == '__main__':
    ...
    # Generate accompaniment and assign the value to variable p_accomp
    ...
    p_melody = melody_gen.generate_melody(chord_progression, melody_rhythm, params.key, params.melody_rest_limit)
